...
C     ------------------------------------------------------            DK230650          
   ...
   14 K=K-1                                                             DK230750          
      ...
      LAB1(K)=RGRSN                                                     DK230771          
      LAB2(K)=LAB2(K-1)                                                 DK230772          
      LAB3(K)=LAB3(K-1)                                                 DK230773          
      LAB4(K)=LAB4(K-1)                                                 DK230774          
   32 K=K-1                                                             DK230780          
...
C     ------------------------------------------------------            DK231570          
   ...
   24 K=K-1                                                             DK231730          
   36 K3=K4                                                             DK231740          
      IF(NON.EQ.0) GO TO 70                                             DK231741          
      DO 71 I=1,NON                                                     DK231742          
   71 NMA(I)=NMA(I)+1                                                   DK231743          
   70 K=NDFA+1                                                          DK231750          
      J=K4+K                                                            DK231760          
      L=J                                                               DK231770          
   ...
   27 CONTINUE                                                          DK231860          
      IF(N2F.EQ.0) GO TO 23                                             DK231861          
      DO 98 I=1,N2F                                                     DK231862          
      INT1(I)=INT1(I)+1                                                 DK231863          
   98 INT2(I)=INT2(I)+1                                                 DK231864          
...
C     ------------------------------------------------------            DK232060          
    7 K2=NDFA+NDFC+NDFAC+1                                              DK232070          
      L=NLHM+K2                                                         DK232080          
      I1=NDFA+NDFC                                                      DK232090          
      K=K2-1                                                            DK232100          
      I2=1                                                              DK232110          
      DO 38 I=1,NRHM                                                    DK232120          
      I3=5000-NDFA*NRHM-(NDFC+NDFAC)*(NRHM-I+1)                         DK232130          
      DO 38 J=1,K                                                       DK232140          
      K4=I3+J-1-NDFA                                                    DK232141          
      IF(J.LE.NDFA) K4=5000-NDFA*(NRHM-I+1)+J-1                         DK232142          
      RHM(I2)=ARRAY(K4)                                                 DK232143          
   38 I2=I2+1                                                           DK232144          
   ...
   47 IF (I.GT.I3) GO TO 48                                             DK232630          
      IF(K4.EQ.K3) GO TO 4                                              DK232631          
      K4=K4+1                                                           DK232632          
      ARRAY(K1)=FAB(K)                                                  DK232640          
      K=K-1                                                             DK232650          
      GO TO 45                                                          DK232660          
    4 I4=I4+1                                                           DK232661          
      IF(I4.EQ.NDFAC) GO TO 5                                           DK232662          
      GO TO 45                                                          DK232663          
    5 I4=0                                                              DK232664          
      K4=0                                                              DK232665          
      K3=K3+1                                                           DK232666          
...
C     ------------------------------------------------------            DK233080          
      I3=NDFA+NDFC+2                                                    DK233081          
      K3=I3+(NDFA+1)*(NDFC+1)                                           DK233090          
      J=301-K3                                                          DK233100          
      K4=101-I3                                                         DK233110          
      DO 54 I=1,K3                                                      DK233120          
      IC(I)=NOS(J)                                                      DK233130          
      IF(I.GT.I3) GO TO 54                                              DK233131          
   ...
   64 IF (NON.EQ.0) GO TO 66                                            DK233210          
      ...
      IF(NMEA.EQ.0) NMA(I)=NMA(I)+2                                     DK233221          
      IF(NMEA.EQ.1) NMA(I)=NMA(I)+1                                     DK233222          
