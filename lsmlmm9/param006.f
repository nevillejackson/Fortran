...
C     ----------------------------------------------------              DK030050          
     ...
     2DFA,IFPC,NDFC,NDFAC,NINT                                          DK030300          
      INTEGER BLANK,CUBIC,MU,QUAD,RGRSN,LINEAR                                            
...
C     ----------------------------------------------------              DK033630          
   ...
   63 I=I+1                                                             DK033790          
   64 IF (LOGE(K).EQ.1) XM(K)=ALOG10(XM(K))                                               
C     ----------------------------------------------------              DK033810          
...
C     ----------------------------------------------------              DK033830          
 ...
 1020 FORMAT (1H0,6HFOR I=,I2,54H  NEGY(I) LNY(I) LHY(I) KBEG(I) NDECY(IDK033910          
   ...
   66 IF(LNY(I).EQ.1) YM(I)=ALOG10(YM(I))                                                 
