c===========================================================================
      subroutine  dxchn3 (kopt,xvec)
c===========================================================================
!                        ... reparameterize based on Cholesky factorization
...
!     apply reparameterization
      do ivar=1,nvars
      call cholsky(ivar,xvec)
      end do

c     transform 1st derivatives
      der1=0.d0
      do ivar=1,nvars
      call first (ivar,xvec)
      end do
...
c     ... diagonal blocks
      do ivar=1,nvars
      call secdia (ivar,xvec)
      end do
c     ... off-diagonal blocks
      do ivar=1,nvars
      do jvar=ivar+1,nvars
      call secoff(ivar,jvar,xvec)
      end do
      end do
...
c     apply log transformation to diagonals
      if(kopt.eq.2)then
         do ivar=1,nvars
         do jvar=ivar+1,nvars
         call logoff(ivar,jvar,xvec)
         end do
         end do
         do ivar=1,nvars
         call logdiag(ivar,xvec)
         end do
      end if
      return
...
c===========================================================================
      subroutine secoff (ivar,jvar,xvec)
c===========================================================================
c     Subroutine to calculate second derivatives of
c     the log-likelihood with respect to elements
...
c     calculate second derivatives
   ...
   50 continue
      ...
      return
      end subroutine secoff

c===========================================================================
      subroutine logdiag (ivar,xvec)
c===========================================================================
...
c===========================================================================
      subroutine logoff (ivar,jvar,xvec)
c===========================================================================
...
c----------------------------------------------------------------------------
      ...
      integer                               :: n1,n2,nr1,nr2,i,ii,iiii,
     &                                         l,ll,m,mm,llmm,kk
