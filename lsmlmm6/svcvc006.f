...
C     ----------------------------------------------------              DK220060          
      IMPLICIT REAL*8(A-H,O-Z)                                          DK220070          
      REAL*8 LAB1,LAB2,LAB3,LAB4,LITY,NLIT,LIT,LITR,NAME,NAM5           DK220080          
 ...
 1001 FORMAT (1H )                                                      DK220560          
   ...
   12 K=NRHM*(I-1)-I*(I-3)/2                                            DK220590          
      ...
      T1=1.-T                                                           DK220620          
      SEH=DSQRT((C1*T1*T1*(1.+(SK3*T))*(1.+(SK3*T)))/C4)                DK220630          
      RP=1.                                                             DK220640          
      RE=1.                                                             DK220650          
      NEG=0                                                             DK220660          
      GO TO 46                                                          DK220670          
   ...
   36 A1=1.+RG                                                          DK220920          
      ...
      SEH=DSQRT(C5)                                                     DK221030          
   40 DEM2=(SSCPR(K)-(E*SSS(K)))*(SSCPR(K1)-(E*SSS(K1)))                DK221040          
      IF (DEM2) 42,44,44                                                DK221050          
   42 DEM2=-DEM2                                                        DK221060          
      RE=(SSCPR(K2)-(E*SSS(K2)))/(DSQRT(DEM2)*(-1.))                    DK221070          
      NEG=1                                                             DK221080          
      GO TO 48                                                          DK221090          
   44 RE=(SSCPR(K2)-(E*SSS(K2)))/DSQRT(DEM2)                            DK221100          
      NEG=0                                                             DK221110          
      GO TO 48                                                          DK221120          
   46 K2=K                                                              DK221130          
