...
C     -------------------------------------------------------             180010          
 ...
 2003 WRITE(IBOP)I,LITY(I),MU,NCDS,SDF,REP,SDF,REP                                        
      WRITE(IBOP)NOM                                                                      
 2002 CONTINUE                                                                            
      L=1                                                                 180057          
      L2=1                                                                180058          
 ...
 2007 WRITE(IBOP)I,J,K1,K,L,LITY(I),L1,LIT(J),IDEN(K),NOS(L),AC,RAP,ALS,                  
     1 REP                                                                                
 2006 CONTINUE                                                                            
      K=K+1                                                               180102          
    5 L=L+1                                                               180103          
...
C     ------------------------------------------------------              180148          
 ...
 2011 WRITE(IBOP)I,J,K1,K,L,LITY(I),L1,NLIT(J),NDEN(K),NOS(L),AC,RAP,                     
     1 ALS,REP                                                                            
 2010 CONTINUE                                                                            
      K=K+1                                                               180151          
   11 L=L+1                                                               180152          
...
C     ------------------------------------------------------              180250          
  ...
  100 ME1=MJ2                                                             180253          
   ...
   33 IF(IBOP)2014,2014,2015                                                              
 2015 WRITE(IBOP)I1,I2                                                                    
 2014 CONTINUE                                                                            
      DO 36 K=I1,I2                                                       180257          
      J2=K-I1+1                                                           180258          
C     ------------------------------------------------------              180259          
...
C     ------------------------------------------------------              180272          
   ...
   38 IF(IBOP)2016,2016,2017                                                              
 2017 WRITE(IBOP)I3,I4                                                                    
 2016 CONTINUE                                                                            
      DO 36 J1=I3,I4                                                      180278          
      AC=0.0                                                                              
      ALS=0.0                                                                             
      RAP=0.0                                                                             
      REP=0.0                                                                             
...
C     ------------------------------------------------------              180310          
 ...
 2019 WRITE(IBOP)I,J,K,J1,L,LITY(I),L1,ID1,ID2,ID3,ID4,NOS(L),AC,RAP,                     
     1 ALS,REP                                                                            
 2018 CONTINUE                                                                            
   36 CONTINUE                                                            180389          
...
C     ------------------------------------------------------              180395          
   21 IF(IBOP)2020,2020,2021                                                              
 2021 WRITE(IBOP)NPR,IE,NLHM                                                              
 2020 CONTINUE                                                                            
      IF (NPR.EQ.0) GO TO 75                                              180396          
      L1=L2+1                                                             180397          
 ...
 2023 WRITE(IBOP)I,J,K,LITY(I),L1,LAB1(J),LAB2(J),LAB3(J),LAB4(J),                        
     1 ARRAY(K),REP                                                                       
 2022 CONTINUE                                                                            
   57 L1=L1+1                                                             180405          
