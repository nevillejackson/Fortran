...
C     ------------------------------------------------------              130008          
 ...
 2001 WRITE(IBOP)I,K,L,LIT(I),IDEN(K),NOS(L),MISS                                         
 2000 CONTINUE                                                                            
      K=K+1                                                               130052          
      MISS=IBLK                                                           130053          
 ...
 2009 WRITE(IBOP)I,K,L,NLIT(I),NDEN(K),NOS(L),MISS                                        
 2008 CONTINUE                                                                            
      MISS=IBLK                                                           130066          
      K=K+1                                                               130067          
 ...
 2013 WRITE(IBOP)I,J,K,L,ID1,ID2,ID3,ID4,NOS(L),MISS                                      
 2012 CONTINUE                                                                            
      MISS=IBLK                                                           130140          
