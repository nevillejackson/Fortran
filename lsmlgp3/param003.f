...
C     ----------------------------------------------------                070039          
    1 READ  (5,1000) IJOB,NAB,NCD,ICN1,NLHM,NRHM,NMEA,NME,NNEA,NNE,N2F,   070040          
     1NPR,NLC,NCPR,IRAN,MPOP,LIOP,IN,NED,IBOP                                             
 1000 FORMAT(21I3)                                                                        
      IF(MPOP.EQ.0.OR.IJOB.EQ.1) GO TO 2051                                               
      WRITE(6,2052)                                                                       
 2052 FORMAT(1H1)                                                                         
 2051 CONTINUE                                                                            
 ...
 2051 FORMAT(1H0,20X,10A8)                                                                
     ...
     1NPR,NLC,NCPR,IRAN,MPOP,LIOP,IN,NED,IBOP                                             
 1002 FORMAT(  100H0IJOB NAB  NCD  ICN1 NLHM NRHM NMEA NME NNEA  NNE  N2                  
     1F  NPR  NLC NCPR IRAN MPOP LIOP   IN  NED IBOP /1H ,I3,I4,18I5)                     
 ...
 2001 WRITE(IBOP)(NEQ(I),I=1,10)                                                          
      WRITE(IBOP)IJOB,NAB,NCD,ICN1,NLHM,NRHM,NMEA,NME,NNEA,NNE,N2F,NPR,                   
     1 NLC,NCPR,IRAN,MPOP,LIOP,IN,NED,IBOP                                                
 2000 CONTINUE                                                                            
      IF(IN) 200,200,201                                                                  
  200 IN=05                                                                               
C     ----------------------------------------------------                070090          
...
C     ----------------------------------------------------                070113          
 ...
 1111 FORMAT(16H0MXNMJC EXCEEDED)                                         070128          
      MULL=1                                                              070129          
  229 CONTINUE                                                            070131          
      IF(IBOP)2004,2004,2005                                                              
 2005 WRITE(IBOP)IAD,NCC,(NDC(I),I=1,NCC)                                                 
 2004 CONTINUE                                                                            
 ...
 2007 WRITE(IBOP)IAD,REP,NCC,(NDC(I),I=1,NCC)                                             
 2006 CONTINUE                                                                            
      RR=REP                                                              070143          
 ...
 1112 FORMAT(16H0MXNMIC EXCEEDED)                                         070160          
      MULL=1                                                              070161          
  235 CONTINUE                                                            070163          
      IF(IBOP)2008,2008,2009                                                              
 2009 WRITE(IBOP)IAD,REP,NMJC,(NDC(I),I=1,NMJC),NMIC,(NMI(I),I=1,NMIC)                    
 2008 CONTINUE                                                                            
      RR=REP                                                              070164          
...
C     ----------------------------------------------------                070169          
 ...
 2011 WRITE(IBOP)I,MEN(I),LIT(I),K7,MPOL,LME(I),IBEG(I),(NOS(J),J=1,K7)                   
 2010 CONTINUE                                                                            
      DO 7 J=1,K7                                                         070184          
      K3=K1+J-1                                                           070185          
 ...
 2013 WRITE(IBOP)I,MEN(I),LIT(I),K7,MPOL,LME(I),IBEG(I),(NOS(J),J=1,K7)                   
 2012 CONTINUE                                                                            
      DO 9 J=1,K7                                                         070206          
      K3=K1+J-1                                                           070207          
...
C     ----------------------------------------------------                070270          
 ...
 2015 WRITE(IBOP)I,NMA(I),NMAC(I),NEN(I),NLIT(I),K7,MPOL,LNE(I),NBEG(I),                  
     1 K1,K2,(NOS(J),J=1,K7)                                                              
 2014 CONTINUE                                                                            
      DO 14 J=1,K7                                                        070286          
      K3=K1+J-1                                                           070287          
 ...
 2017 WRITE(IBOP)I,NMA(I),NMAC(I),MEN(I),NLIT(I),K7,MPOL,LNE(I),NBEG(I),                  
     1 K1,K2,(NOS(J),J=1,K7)                                                              
 2016 CONTINUE                                                                            
      DO 22 J=1,K7                                                        070309          
      K3=K1+J-1                                                           070310          
...
C     ----------------------------------------------------                070369          
 ...
 2019 WRITE(IBOP)I,INT1(I),INT2(I),K7,K1,K2,(NOS(J),J=1,K7)                               
 2018 CONTINUE                                                                            
      IF(K7) 266,266,267                                                                  
  267 DO 26 J=1,K7                                                                        
      K3=K1+J-1                                                           070387          
...
C     ----------------------------------------------------                070487          
 ...
 2021 WRITE(IBOP)K,NEGX(K),LOGE(K),LQC(K),NREGP(K),LGTX(K),JBEG(K),                       
     1 NDECX(K),XM(K),LITR(K)                                                             
 2020 CONTINUE                                                                            
C     ----------------------------------------------------                070500          
...
C     ----------------------------------------------------                070527          
 ...
 2023 WRITE(IBOP)I,NEGY(I),LNY(I),LHY(I),KBEG(I),NDECY(I),YM(I),LITY(I)                   
 2022 CONTINUE                                                                            
 ...
 2025 WRITE(IBOP)I309,NR1,NW,NS2,(MS(I),I=1,NS2)                                          
 2024 CONTINUE                                                                            
...
C     ----------------------------------------------------                070554          
 ...
 2027 END FILE IBOP                                                                       
      WRITE(IBOP) NS,(IM(I),I=1,NS),IE                                                    
      END FILE IBOP                                                                       
      J=IM(NS)                                                                            
      WRITE(IBOP)J,(LAB1(I),LAB2(I),LAB3(I),LAB4(I),I=1,J)                                
      END FILE IBOP                                                                       
 2026 CONTINUE                                                                            
      RETURN                                                              070571          
      END                                                                 070572          
