...
C     ----------------------------------------------------              DEC04003          
      ...
      DIMENSION ARRAY(2000),SSCPR(630),SSS(630),RHM(0250),TOT(106),TOT2(DEC04005          
     1106),TOT3(106),LAB1(100),LAB2(100),LAB3(100),LAB4(100)            DEC04006          
     ...
     6EFF1(50),EFF2(50),NOS(200),X(106),NMAC(40)                        DEC04013          
 ...
 1001 FORMAT (1H1,20X,35HLISTING OF X MATRIX FOR PROBLEM NO.,I3)        DEC04028          
   ...
   10 NOS(I)=0                                                          DEC04047          
      ...
      NCDG=0                                                            DEC04053          
      NMIG=1                                                            DEC04054          
   20 READ(IN,2000)(IRWC(I),I=1,10)                                     M0204055          
 2000 FORMAT(10A8)                                                      M0104056          
 1000 FORMAT(80A1)                                                      M0104057          
      NTRA=0                                                            DEC04058          
      DO 21 I=1,10                                                      M0104059          
   21 IF(IRWC(I).NE.IBLK) NTRA=1                                        M0104060          
      IF (NTRA.EQ.0) GO TO 156                                          DEC04061          
      DECODE (80,2001,IRWC(1)) (IC(I),I=1,80)                           M0104062          
 2001 FORMAT(80I1)                                                      M0104063          
      NCDS=NCDS+1                                                       DEC04065          
      IF (NCD.LT.2) GO TO 32                                            DEC04066          
      DO 30 J=2,NCD                                                     DEC04067          
      L=J*80                                                            DEC04068          
      K=L-79                                                            DEC04069          
      READ(IN,2000)(IRWC(I),I=1,10)                                     M0204070          
      DECODE (80,2001,IRWC(1)) (IC(I),I=K,L)                            M0104071          
