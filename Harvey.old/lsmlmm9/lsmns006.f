...
C     ------------------------------------------------------            DK141860          
      ...
      IF(MTY.GT.1) REP=SQTF(REP*REP+AD)                                                   
      IF (NMA(J).EQ.1.AND.(MTY.EQ.3.OR.MTY.EQ.5.OR.MTY.EQ.7)) GO TO 205 DK141890          
      GO TO 206                                                         DK141900          
  205 YT=1.0/FLOAT(K2)                                                  DK141910          
      K6=NMAC(J)                                                        DK141920          
      SS=REP*REP-AD                                                     DK141930          
      IF(MTY.EQ.3) REP = SQTF(SS+(SS*R1I(K6)*YT*SAB(LL))/WK)                              
      IF (MTY.EQ.5.OR.MTY.EQ.7) REP= SQTF(SS+(SS*YT*(R1I(K6)*FY(LL)+R2I(                  
...
C     ------------------------------------------------------            DK143570          
  ...
  203 SS=REP*REP-AD                                                     DK144360          
      ...
      IF (MTY.EQ.3) REP= SQTF(SS+(SS*YT*R1I(K1)*SAB(LL))/WK)                              
      IF(MTY.EQ.5) REP= SQTF(SS+(SS*YT*(R1I(K1)*FY(LL)+R2I(K1)*SAB(LL))                   
     1)/WK)                                                             DK144420          
      IF(MTY.EQ.6) REP =SQTF(SS+(SS*YT*TOT4(K1)*(SAB(LL)+FY(LL)))/WK)                     
      IF (MTY.EQ.7) REP= SQTF(SS+(SS*YT*R1I(K1)*SAB(LL))/WK+R2I(K1)*YT*R                  
