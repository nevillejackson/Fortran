...
C     --------------------------------------------------                DEC01005          
      DIMENSION ARRAY(8550),SSCPR(1260),SSS(1260),RHM(3500),            DEC01006          
     1  TOT(136),TOT2(136),TOT3(136),                                   DEC01007          
     2  LAB1(100),LAB2(100),LAB3(100),LAB4(100)                         DEC01007          
     ...
     6EFF1(50),EFF2(50),NOS(250),X(136),NMAC(40)                        DEC01014          
  ...
  910 CALL READIN(IC,IN,NTRA,IBLK,1,80,1)                               M0301045          
      IF (NTRA.EQ.1) GO TO 910                                          DEC01050          
  913 IF(MPOP-1) 914,1,915                                              M0301051          
  915 REWIND IN                                                         M0301052          
      GO TO 1                                                           M0301053          
  914 RETURN                                                            M0301054          
      END                                                               M0301055          
*ENDTEXT                                                                                  
