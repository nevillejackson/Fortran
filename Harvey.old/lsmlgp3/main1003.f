...
C     ----------------------------------------------------                060010          
 ...
 2001 WRITE(IBOP)NLHM,NRHM,MATX,NOT                                                       
      END FILE IBOP                                                                       
 2000 CONTINUE                                                                            
...
C     ----------------------------------------------------                060080          
  ...
  792 NCDS=NCDS-1                                                         060084          
      GO TO 20                                                            060085          
  790 CONTINUE                                                            060086          
      IF(IBOP)2102,2102,2103                                                              
 2103 NCD80=NCD*80                                                                        
      WRITE(IBOP)(IC(I),I=1,NCD80)                                                        
 2102 CONTINUE                                                                            
C     ------------------------------------------------------                              
C     SET UP X VECTOR AND SUM PRODUCTS                                                    
C     ------------------------------------------------------                              
...
C     ----------------------------------------------------                060131          
  ...
  124 CONTINUE                                                            060177          
C-----MINOR CLASS TOTALS                                                                  
  130 IF(IBOP)2006,2006,2007                                                              
 2007 IF(NAB.EQ.4) GO TO 2008                                                             
      WRITE(13)IMJ2,NCDG,(TOT(I),I=1,NOT)                                                 
      GO TO 2006                                                                          
 2008 WRITE(13)IMI2,NMIG,(TOT(I),I=1,NOT)                                                 
 2006 CONTINUE                                                                            
      IF(LIOP.EQ.0.OR.LIOP.EQ.5.OR.LIOP.EQ.10) GO TO 135                                  
 ...
 1050 FORMAT (1H ,10X,14HMINOR CLASS IS,I12,6H   NI=,I4/1H ,   6HTOTALS)  060181          
  ...
  154 TOT(I)=0.0                                                          060215          
      ...
      GO TO 109                                                           060218          
C-----EOF FOR FILE 5 ON IBOP - IC ARRAYS                                                  
  156 IF(IBOP)2104,2104,2105                                                              
 2105 END FILE IBOP                                                                       
      WRITE(IBOP) NAB,NOT                                                                 
 2104 CONTINUE                                                                            
...
C-----MAJOR CLASS TOTALS                                                                  
  184 IF(IBOP) 2004,2004,2005                                                             
 2005 WRITE(14)IMJ2,GNI,(TOT2(I),I=1,NOT)                                                 
 2004 CONTINUE                                                                            
      IF(LIOP.EQ.0.OR.LIOP.EQ.5) GO TO 190                                                
 ...
 1060 FORMAT (1H1,5X,53HTOTAL LEAST-SQUARES ANALYSIS.  NO EQUATIONS ABSO  060299          
     1RBED.,5X,13HDF=NO. CARDS=,I5)                                       060300          
      WRITE(6,5000)(NEQ(I),I=1,10)                                                        
      IF(IBOP)2010,2010,2011                                                              
 2011 WRITE(IBOP)NCDS                                                                     
      DO 2012 I=1,NCDS                                                                    
      READ(12)(X(J),J=1,NOT)                                                              
 2012 WRITE(IBOP)(X(J),J=1,NOT)                                                           
      END FILE IBOP                                                                       
 2010 CONTINUE                                                                            
      GO TO 310                                                           060301          
 ...
 1061 FORMAT (1H1,21X,38HEQUATION FOR THE OVERALL MEAN ABSORBED,5X,3HDF=  060303          
     1,F5.0)                                                              060304          
      WRITE(6,5000)(NEQ(I),I=1,10)                                                        
      IF(IBOP)2014,2014,2015                                                              
 2015 WRITE(IBOP)NCDS,DF                                                                  
      DO 2016 I=1,NCDS                                                                    
      READ(12)(X(J),J=1,NOT)                                                              
 2016 WRITE(IBOP)(X(J),J=1,NOT)                                                           
      END FILE IBOP                                                                       
 2014 CONTINUE                                                                            
      GO TO 310                                                           060305          
 ...
 1062 FORMAT (1H1,10X,55HNO. OF CLASSES OR SUBCLASSES ABSORBED BY LEAST   060307          
     1SQUARES=,I4,5X,10HNO. CARDS=,I5,5X,3HDF=,F5.0)                      060308          
      WRITE(6,5000)(NEQ(I),I=1,10)                                                        
      IF(IBOP)2018,2018,2019                                                              
 2019 WRITE(IBOP)MJN,NCDS,DF                                                              
      DO 2021 I=1,MJN                                                                     
      READ(13)IMJ2,NCDG,(X(J),J=1,NOT)                                                    
 2021 WRITE(IBOP)IMJ2,NCDG,(X(J),J=1,NOT)                                                 
      DO 2020 I=1,NCDS                                                                    
      READ(12)(X(J),J=1,NOT)                                                              
 2020 WRITE(IBOP)(X(J),J=1,NOT)                                                           
      END FILE IBOP                                                                       
 2018 CONTINUE                                                                            
      GO TO 310                                                           060309          
 ...
 1063 FORMAT (1H1,60HNO. OF CLASSES OR SUBCLASSES ABSORBED BY MAXIMUM LI  060311          
     1KELIHOOD=,I4,3X,7H1-R/R =,F7.4,3X,10HNO. CARDS=,I5,3X,3HDF=,F5.0)   060312          
      WRITE(6,5000)(NEQ(I),I=1,10)                                                        
      IF(IBOP)2022,2022,2023                                                              
 2023 WRITE(IBOP)MJN,REP,NCDS,DF                                                          
      DO 2024 I=1,MJN                                                                     
      READ(13)IMJ2,NCDG,(X(J),J=1,NOT)                                                    
 2024 WRITE(IBOP)IMJ2,NCDG,(X(J),J=1,NOT)                                                 
      DO 2025 I=1,NCDS                                                                    
      READ(12)(X(J),J=1,NOT)                                                              
 2025 WRITE(IBOP)(X(J),J=1,NOT)                                                           
      END FILE IBOP                                                                       
 2022 CONTINUE                                                                            
      GO TO 310                                                           060313          
 ...
 1064 FORMAT (1H1,37H NO. OF MAJOR CLASSES ABSORBED BY ML=,I4,3X,21HNO.   060318          
     ...
     3=,F5.0)                                                             060320          
      WRITE(6,5000)(NEQ(I),I=1,10)                                                        
      IF(IBOP)2026,2026,2027                                                              
 2027 WRITE(IBOP)MJN,MIN,REP,NCDS,DF                                                      
      DO 2028 I=1,MJN                                                                     
      READ(14)IMJ2,GNI,(X(J),J=1,NOT)                                                     
 2028 WRITE(IBOP)IMJ2,GNI,(X(J),J=1,NOT)                                                  
      DO 2029 I=1,MIN                                                                     
      READ(13)IMI2,NMIG,(X(J),J=1,NOT)                                                    
 2029 WRITE(IBOP)IMI2,NMIG,(X(J),J=1,NOT)                                                 
      DO 2030 I=1,NCDS                                                                    
      READ(12)(X(J),J=1,NOT)                                                              
 2030 WRITE(IBOP)(X(J),J=1,NOT)                                                           
      END FILE IBOP                                                                       
 2026 CONTINUE                                                                            
  310 IF (NOM+NON.EQ.0) GO TO 320                                         060321          
     ...
     5EFF2,NOS,X,NMAC,IED)                                                                
      IF((NLHM.EQ.0.OR.(NPR.EQ.0.AND.LIOP.EQ.10)).AND.IBOP.EQ.0)GOTO 330                  
      IF (NLHM.EQ.0.OR.(NPR.EQ.0.AND.LIOP.EQ.10)) GO TO 3300              060328          
 ...
 1102 FORMAT (1H )                                                        060336          
      L=1                                                                 060337          
      K3=1                                                                060338          
 3300 IF(IBOP)2035,2035,2036                                                              
 2036 WRITE(IBOP)NLHM                                                                     
      IF(NLHM)2034,2034,3301                                                              
 2035 IF(NLHM)330,330,3301                                                                
 3301 CONTINUE                                                                            
  ...
  392 K3=K3+1                                                             060359          
      L=3                                                                 060360          
      IF(NPR.EQ.0.AND.LIOP.EQ.10) GO TO 3302                                              
  328 WRITE (6,1103) I,LAB1(I),LAB2(I),LAB3(I),LAB4(I),AMN,SD             060361          
 3302 IF(IBOP)2031,2031,2032                                                              
 2032 WRITE(IBOP)I,LAB1(I),LAB2(I),LAB3(I),LAB4(I),AMN,SD                                 
 2031 CONTINUE                                                                            
  329 CONTINUE                                                            060362          
      IF(IBOP)2033,2033,2034                                                              
 2034 END FILE IBOP                                                                       
 2033 CONTINUE                                                                            
 1103 FORMAT(1H ,I6,6X,A6,2(1X,A6),A6,2F13.5)                             060363          
  330 IF (NRHM.EQ.0 .AND. IBOP.EQ.0) GO TO 342                                            
      IF(NRHM.EQ.0) GO TO 3303                                                            
      WRITE (6,1104)                                                      060365          
 1104 FORMAT (1H1,15X,44HOVERALL MEANS AND STANDARD DEVIATIONS OF RHM)    060366          
      WRITE(6,5000)(NEQ(I),I=1,10)                                                        
      WRITE (6,1102)                                                      060367          
      L=NLHM*(NLHM+1)/2                                                   060368          
 3303 IF(IBOP)2037,2037,2038                                                              
 2038 WRITE(IBOP)NRHM                                                                     
      IF(NRHM)2042,2042,3420                                                              
 2037 IF(NRHM)342,342,3420                                                                
 3420 CONTINUE                                                                            
  ...
  338 AMN=AMN+YM(I)                                                       060382          
      IF(IBOP)2039,2039,2040                                                              
 2040 WRITE(IBOP)I,LITY(I),AMN,SD                                                         
 2039 CONTINUE                                                                            
  340 WRITE (6,1105) LITY(I),AMN,SD                                       060383          
 1105 FORMAT (1H ,12X,A6,4X,5HMEAN=,F12.5,10X,5HS.D.=,F12.5)              060384          
      IF(IBOP)2041,2041,2042                                                              
 2042 END FILE IBOP                                                                       
 2041 CONTINUE                                                                            
  342 IF(LIOP.EQ.7 .AND. IBOP.EQ.0) GO TO 500                                             
  344 IF(NLHM.EQ.0 .AND. IBOP.EQ.0) GO TO 359                                             
      IF(IE.GT.NLHM .AND. LIOP.EQ.10 .AND. IBOP.EQ.0) GO TO 359                           
      IF(LIOP.EQ.7.OR.NLHM.EQ.0.OR.(IE.GT.NLHM.AND.LIOP.EQ.10))GOTO2050                   
      WRITE (6,1102)                                                      060388          
 ...
 2050 IF(IBOP)2051,2051,2052                                                              
 2052 WRITE(IBOP)NLHM                                                                     
      IF(NLHM)3590,3590,2053                                                              
 2051 IF(NLHM)359,359,2053                                                                
 2053 CONTINUE                                                                            
      DO 360 I=1,NLHM                                                     060397          
      DO 360 J=I,NLHM                                                     060398          
      IF (I.LT.IE.AND.J.LT.IE.AND.LIOP.EQ.10) GO TO 3600                  060399          
  ...
  356 IF (I.LT.IE.AND.LIOP.EQ.10) GO TO 3600                              060415          
      IF (I.NE.J) GO TO 358                                               060416          
      RLHM=1.                                                             060417          
      IF(LIOP.EQ.7.OR.(IE.GT.NLHM.AND.LIOP.EQ.10)) GO TO 3600                             
      WRITE (6,1102)                                                      060418          
  358 IF(LIOP.EQ.7.OR.(IE.GT.NLHM.AND.LIOP.EQ.10)) GO TO 3600                             
      WRITE (6,1109) I,J,LAB1(I),LAB2(I),LAB3(I),LAB4(I),LAB1(J),LAB2(J)  060419          
     1,LAB3(J),LAB4(J),ARRAY(K3),RLHM                                     060420          
 3600 IF(IBOP)2054,2054,2055                                                              
 2055 WRITE(IBOP)I,J,K3,LAB1(I),LAB2(I),LAB3(I),LAB4(I),LAB1(J),LAB2(J),                  
     1 LAB3(J),LAB4(J),ARRAY(K3),RLHM                                                     
 2054 CONTINUE                                                                            
  360 CONTINUE                                                            060421          
 1109 FORMAT(1H ,I3,I5,2X,A6,2(1X,A6),2A6,2(1X,A6),A6,2X,F21.8,F13.4)     060422          
 3590 IF(IBOP)2056,2056,2057                                                              
 2057 END FILE IBOP                                                                       
 2056 CONTINUE                                                                            
  359 IF(NLHM.EQ.0 .AND. IBOP.EQ.0) GO TO 386                                             
      IF(((IE.GT.NLHM.AND.LIOP.EQ.10).OR.LIOP.EQ.7).AND.IBOP.EQ.0) GO TO                  
     1 376                                                                                
      WRITE (6,1102)                                                      060425          
 ...
 2060 IF(IBOP)2061,2061,2062                                                              
 2062 WRITE(IBOP)NLHM,NRHM                                                                
      IF(NLHM.EQ.0 .OR. NRHM.EQ.0) GO TO 3760                                             
      GO TO 2063                                                                          
 2061 IF(NLHM.EQ.0 .OR. NRHM.EQ.0) GO TO 376                                              
 2063 CONTINUE                                                                            
      DO 375 I=1,NRHM                                                     060432          
      K4=NLHM+I                                                           060433          
      IF((IE.GT.NLHM.AND.LIOP.EQ.10).OR.LIOP.EQ.7) GO TO 2064                             
      WRITE (6,1102)                                                      060434          
 2064 CONTINUE                                                                            
      DO 375 J=1,NLHM                                                     060435          
      IF (J.LT.IE.AND.LIOP.EQ.10) GO TO 3750                              060436          
  ...
  374 IF((IE.GT.NLHM.AND.LIOP.EQ.10).OR.LIOP.EQ.7) GO TO 3750                             
      WRITE (6,1112) I,J,LITY(I),LAB1(J),LAB2(J),LAB3(J),LAB4(J),RHM(K2)  060455          
     1,RLR                                                                060456          
 3750 IF(IBOP)2065,2065,2066                                                              
 2066 WRITE(IBOP)I,J,K2,LITY(I),LAB1(J),LAB2(J),LAB3(J),LAB4(J),RHM(K2),                  
     1 RLR                                                                                
 2065 CONTINUE                                                                            
  375 CONTINUE                                                            060457          
 1112 FORMAT (1H ,I3,I5,A9,2X,2(A6,1X),2A6,2X,F21.8,F10.4)                060458          
 3760 IF(IBOP) 2068,2068,2067                                                             
 2067 END FILE IBOP                                                                       
 2068 CONTINUE                                                                            
  376 IF(NCPR.EQ.0 .AND. IBOP.EQ.0) GO TO 386                                             
      IF(NCPR.EQ.0.OR.LIOP.EQ.7.OR.NLHM.EQ.0) GO TO 2070                                  
      WRITE (6,1102)                                                      060460          
 ...
 2070 IF(IBOP)2071,2071,2072                                                              
 2072 WRITE(IBOP)NLHM,NRHM,NCPR                                                           
      IF(NLHM.EQ.0 .OR. NCPR.EQ.0) GO TO 3860                                             
      GO TO 2073                                                                          
 2071 IF(NLHM.EQ.0 .OR. NCPR.EQ.0) GO TO 386                                              
 2073 CONTINUE                                                                            
  ...
  380 RLHM=SSCPR(K3)/SQRT(SSCPR(K)*SSCPR(K1))                             060480          
      IF(LIOP.EQ.7) GO TO 2074                                                            
  382 IF (I.NE.J) GO TO 3840                                              060481          
      WRITE (6,1102)                                                      060482          
 3840 WRITE (6,1115) I,J,LITY(I),LITY(J),SSCPR(K3),RLHM                   060483          
 2074 IF(IBOP)2075,2075,2078                                                              
 2078 WRITE(IBOP)I,J,K3,LITY(I),LITY(J),SSCPR(K3),RLHM                                    
 2075 CONTINUE                                                                            
  384 CONTINUE                                                                            
 1115 FORMAT (1H ,20X,I3,I6,A9,A8,2X,F23.8,F14.4)                         060484          
 3860 IF(IBOP)2076,2076,2077                                                              
 2077 END FILE IBOP                                                                       
 2076 CONTINUE                                                                            
  386 N=NLHM                                                              060485          
  500 CONTINUE                                                            060486          
