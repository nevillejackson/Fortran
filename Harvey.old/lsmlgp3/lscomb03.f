...
C     ----------------------------------------------------                140040          
 ...
 2000 IF(IBOP)2001,2001,2002                                                              
 2002 WRITE(IBOP)NLHM                                                                     
 2001 CONTINUE                                                                            
 ...
 2003 IF(IBOP)2004,2004,2005                                                              
 2005 WRITE(IBOP)I,J,K1,LAB1(I),LAB2(I),LAB3(I),LAB4(I),LAB1(J),LAB2(J),                  
     1 LAB3(J),LAB4(J),ARRAY(K1)                                                          
 2004 CONTINUE                                                                            
   32 CONTINUE                                                            140065          
      IF(IBOP)2006,2006,2007                                                              
 2007 END FILE IBOP                                                                       
 2006 CONTINUE                                                                            
C     ----------------------------------------------------                140066          
...
C     ----------------------------------------------------                140068          
 ...
 1007 FORMAT (1H0,10H RHM   ROW,43X,18HCONSTANT ESTIMATES/ 1H ,33H NAME   140075          
     ...
     2NT FORMAT)                                                          140077          
   55 IF(IBOP)2010,2010,2011                                                              
 2011 WRITE(IBOP)NRHM,NLHM                                                                
 2010 CONTINUE                                                                            
      DO 54 K=1,NRHM                                                      140078          
      WRITE (6,1004)                                                      140079          
   34 TREDS=0.0                                                           140080          
   ...
   48 TREDS=TREDS+RHM(K4)*TEMP                                            140091          
      ...
      IF(IBOP)2012,2012,2013                                                              
 2013 WRITE(IBOP)K,I,LITY(K),LAB1(I),LAB2(I),LAB3(I),LAB4(I),TEMP,K1                      
 2012 CONTINUE                                                                            
 ...
 2015 WRITE(IBOP)K,TRED(K)                                                                
 2014 CONTINUE                                                                            
   54 CONTINUE                                                            140100          
      IF(IBOP)2016,2016,2017                                                              
 2017 END FILE IBOP                                                                       
      WRITE(IBOP)NAB,NMEA,NNEA                                                            
 2016 CONTINUE                                                                            
  ...
  299 IF(IBOP)2018,2018,2019                                                              
 2019 END FILE IBOP                                                                       
      WRITE(IBOP)NLC,NRHM                                                                 
 2018 CONTINUE                                                                            
      IF (NLC.EQ.0) GO TO 53                                              140110          
      WRITE (6,1051)                                                      140111          
 ...
 1053 FORMAT(1H0,2A6,A2,2X,I3,2X,9(I3,1X,F4.0,2X)/17X,9(I3,1X,F4.0,2X))                   
      IF(IBOP)2020,2020,2021                                                              
 2021 WRITE(IBOP)K1,IA1,IA2,IA3,NERC,NBRC,(JBEG(J),TOT2(J),J=1,NERC)                      
 2020 CONTINUE                                                                            
 ...
 2023 WRITE(IBOP)K1,I,LITY(I),ALS,REP                                                     
 2022 CONTINUE                                                                            
...
C     ----------------------------------------------------                140148          
   53 NERC=0                                                              140149          
      IF(IBOP)2024,2024,2025                                                              
 2025 END FILE IBOP                                                                       
      WRITE(IBOP)NS,(IM(I),I=1,NS),NLHM                                                   
 2024 CONTINUE                                                                            
 ...
 2027 DO 2028 I=NBRC,NERC                                                                 
      DO 2028 J=I,NERC                                                                    
      K1=NLHM*(I-1)-I*(I-3)/2+J-I                                                         
 2028 WRITE(IBOP)I2,I,J,NBRC,NERC,LAB1(I),LAB2(I),LAB3(I),LAB4(I),                        
     1 LAB1(J),LAB2(J),LAB3(J),LAB4(J),K1,ARRAY(K1)                                       
 2026 CONTINUE                                                                            
      SUMD=0.0                                                                            
      SUMO=0.0                                                                            
 ...
 2135 IF(LIOP.LT.3.OR.LIOP.EQ.10)GO TO 2132                                               
      WRITE (6,1005) I,J,LAB1(I),LAB2(I),LAB3(I),LAB4(I),LAB1(J),LAB2(J)  140165          
     1,LAB3(J),LAB4(J),ARRAY(K1),ARRAY(K1)                                140166          
 2132 IF(IBOP)2031,2031,2032                                                              
 2032 WRITE(IBOP)I2,I,J,NBRC,NERC,LAB1(I),LAB2(I),LAB3(I),LAB4(I),                        
     1 LAB1(J),LAB2(J),LAB3(J),LAB4(J),K1,ARRAY(K1)                                       
 2031 CONTINUE                                                                            
  220 CONTINUE                                                            140167          
 ...
 2136 FORMAT(1H ,2(I3,2X),2(A6,1X),2A6,2(A6,1X),2A6,46X,F20.8)                            
      IF(IBOP)2137,2137,2138                                                              
 2138 WRITE(IBOP)SUMD,SUMO,WK,CK                                                          
 2137 CONTINUE                                                                            
   58 CONTINUE                                                            140168          
      IF(IBOP)2033,2033,2034                                                              
 2034 END FILE IBOP                                                                       
      WRITE(IBOP)NCPR,I309,NRHM                                                           
 2033 CONTINUE                                                                            
C     ----------------------------------------------------                140169          
...
C     ----------------------------------------------------                140171          
 ...
 1010 FORMAT (1H ,I4,I3,I4,2X,2A8,F22.6, 3X,F20.8,F14.4)                  140204          
      IF(IBOP)2074,2074,2035                                                              
 2035 WRITE(IBOP)K,L,LITY(K),LITY(L),ESS,EMS,F                                            
 2074 CONTINUE                                                                            
C     ----------------------------------------------------                140205          
C     CALLS POLYNO SUBROUTINE IF POLYNOMIALS ARE TO BE FITTED             140206          
C     ----------------------------------------------------                140207          
   77 IF(IBOP)2036,2036,2037                                                              
 2037 END FILE IBOP                                                                       
      WRITE(IBOP)NSME,NRHM                                                                
 2036 IF(NSME.EQ.0) GO TO 76                                                              
      CALL POLYNO(                                                        140209          
...
C     ----------------------------------------------------                140217          
 ...
 1011 FORMAT (1H1,28X,34HLEAST-SQUARES ANALYSIS OF VARIANCE)              140219          
      ...
      WRITE(6,5000)(NEQ(I),I=1,10)                                                        
      IF(IBOP)2038,2038,2039                                                              
 2039 END FILE IBOP                                                                       
      WRITE(IBOP)NAB,NRHM,NS,(IM(I),I=1,NS),NCPR,I309,NSME,(NND(I),I=1,                   
     1 NSME)                                                                              
 2038 CONTINUE                                                                            
 ...
 1012 FORMAT (1H / 42X,A6)                                                140224          
      IF(IBOP)2040,2040,2041                                                              
 2041 WRITE(IBOP)K,LITY(K)                                                                
 2040 CONTINUE                                                                            
      WRITE (6,1013)                                                      140225          
 ...
 1015 FORMAT (1H ,15HTOTAL REDUCTION,I8,F20.6,F18.6,F13.3)                140256          
      IF(IBOP)2046,2046,2047                                                              
 2047 WRITE(IBOP)K,NLHM,TRED(K),RECIP,F                                                   
 2046 CONTINUE                                                                            
      K3=3                                                                140257          
      NERC=0                                                              140258          
      L2=1                                                                140259          
 ...
 1016 FORMAT (1H ,A6,1X,A1,A7,I6,2X,F20.6,F18.6,F13.3)                    140290          
      IF(IBOP)2048,2048,2049                                                              
 2049 WRITE(IBOP)K5,I3,LAB1(K5),I2,LAB3(K5),K6,TREDS,SS,R                                 
 2048 CONTINUE                                                                            
 ...
 1027 FORMAT (1H ,2X,A6,10X,1H1,4X,F20.6,F18.6,F13.3)                     140299          
      IF(IBOP)2050,2050,2051                                                              
 2051 WRITE(IBOP)L,I,LP(L),SSS(I),SSS(I),R                                                
 2050 CONTINUE                                                                            
      SS=SS+SSS(I)                                                        140300          
   20 CONTINUE                                                            140301          
 ...
 1028 FORMAT (1H ,2X,8HRESIDUAL,4X,I5,4X,F20.6,F18.6,F13.3)               140308          
      IF(IBOP)2052,2052,2053                                                              
 2053 WRITE(IBOP)I,TREDS,SS,R                                                             
 2052 CONTINUE                                                                            
  104 CONTINUE                                                            140309          
      K6=EDF                                                              140310          
...
C     ----------------------------------------------------                140326          
 ...
 2057 CONTINUE                                                                            
  ...
  144 CONTINUE                                                            140374          
      WK=AK/SDF                                                           140375          
      IF(IBOP)2067,2067,2068                                                              
 2068 WRITE(IBOP)WK,SDF                                                                   
 2067 CONTINUE                                                                            
      WRITE (6,1018) WK,SDF                                               140376          
 1018 FORMAT (1H1,10X,32HK FOR RANDOM EFFECTS COMPONENT =,F9.4,3X,20HDEG  140377          
 ...
 1019 FORMAT (1H0/25X,51HSS, CP, MS, MCP, VARIANCE AND COVARIANCE COMPON  140380          
     ...
     2COV,18X,10HCOMPONENTS)                                              140382          
      ...
      IF(IBOP)2059,2059,2060                                                              
 2060 WRITE(IBOP)I,J,K,LITY(I),LITY(J),SSS(K),SMS,SOD                                     
 2059 CONTINUE                                                                            
      WRITE (6,1020) IJOB,I,J,LITY(I),LITY(J),SSS(K),SMS,SOD              140389          
 1020 FORMAT (1H ,I3,2I4,2A8,3F27.8)                                      140390          
  146 SSS(K)=SMS                                                          140391          
  148 IF(IBOP)2061,2061,2062                                                              
 2062 END FILE IBOP                                                                       
      WRITE(IBOP)I309,NRHM                                                                
 2061 CONTINUE                                                                            
      IF(IRAN .EQ. 0) GO TO 150                                                           
C     ----------------------------------------------------                140393          
