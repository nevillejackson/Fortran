...
C     ----------------------------------------------------                140040          
      CALL REMARK(21H   STARTING INVERSION)                                               
      NBRC=1                                                              140041          
      NERC=NLHM                                                           140042          
 ...
 5000 FORMAT(1H0,20X,10A8)                                                                
      WRITE (6,1004)                                                      140045          
      IF(LIOP.NE.20) GO TO 5010                                                           
      WRITE(6,5011)                                                                       
 5011 FORMAT(1H0,3HROW,9X,16HDIAGONAL ELEMENT,9X,10HRECIPROCAL)                           
      DO 5012 I=NBRC,NERC                                                                 
      K1=NLHM*(I-1)-I*(I-3)/2                                                             
 5012 WRITE(6,5013) I,ARRAY(K1),1./ARRAY(K1)                                              
 5013 FORMAT(1H ,I3,8X,F17.8,2X,F17.8)                                                    
      GO TO 19                                                                            
 5010 IF(LIOP.NE.10) GO TO 26                                                             
      DO 5001 I=NBRC,NERC                                                                 
 ...
 1005 FORMAT (1H ,2(I3,2X),2(A6,1X),2A6,2(A6,1X),2A6,2X,F17.8,8X,E15.8)   140064          
   32 CONTINUE                                                            140065          
      CALL REMARK(51H   INVERSION COMPLETED - STARTING COMPUTE CONSTANTS                  
     1)                                                                                   
C     ----------------------------------------------------                140066          
...
C     ----------------------------------------------------                140068          
 ...
 1050 FORMAT(2A6,A2,2I3,10(I3,F3.0)/(13(I3,F3.0),2X))                                     
 ...
 1054 FORMAT (1H0,A6,5X,17HLINEAR FUNCTION =,F17.8,4X,16HSTANDARD ERROR   140143          
     1=,F17.8)                                                            140144          
      CALL REMARK(48H   CONSTANTS COMPLETED - STARTING BACK INVERSION)                    
C     ----------------------------------------------------                140145          
...
C     ----------------------------------------------------                140148          
 ...
 1000 FORMAT(1H1,10X,71HLISTING OF INVERSE ELEMENTS OF SEGMENTS AND/OR K                  
     1-VALUES FOR PROBLEM NO.,I3)                                                         
      WRITE(6,5000)(NEQ(I),I=1,10)                                                        
      IF(LIOP.LT.3.OR.LIOP.GE.10) GO TO 221                                               
      WRITE(6,3022)                                                                       
 ...
 2135 IF(LIOP.LT.3.OR.LIOP.GE.10) GO TO 220                                               
  ...
  220 CONTINUE                                                            140167          
      ...
      IF(NAB.EQ.1.OR.NAB.EQ.2.OR.NAB.EQ.4) GO TO 4000                                     
      NSUB=0                                                                              
 ...
 4000 NSUB=1                                                                              
      IF(I2.GT.(NME+NNE+N2F)) 3005,4001                                                   
 4001 IF(I2.LE.(NME+NNE)) 3007,4002                                                       
 4002 IF(I2.GT.(NME+NNE).AND.I2.LE.(NME+NNE+N2F)) 3000,3009                               
 3005 NDEL=0                                                                              
      GO TO 3001                                                                          
 3007 NDEL=1                                                                              
      GO TO 3001                                                                          
 ...
 3000 DO 3002 IXZ=1,N2F                                                                   
      IF(I2.EQ.(1-NSUB+NME+NNE+IXZ)) 3003,3002                                            
 3003 IXY=IXZ                                                                             
      GO TO 3004                                                                          
 3002 CONTINUE                                                                            
 3004 IX1=INT1(IXY)                                                                       
      IX2=INT2(IXY)                                                                       
      MSUB=NME+NMEA                                                                       
      IF(IX1.LE.MSUB.AND.IX2.LE.MSUB) 3011,3012                                           
 3012 IF(IX1.LE.MSUB.AND.IX2.GT.MSUB) 3013,3014                                           
 3014 IF(IX1.GT.MSUB.AND.IX2.LE.MSUB) 3015,3016                                           
 3016 IF(IX1.GT.MSUB.AND.IX2.GT.MSUB) 3017,3018                                           
 3018 KPUT=1                                                                              
 ...
 3011 NDEL=NCL(IX1)+NCL(IX2)-1                                                            
      GO TO 3001                                                                          
 3013 NDEL=NCL(IX1)+NCLN(IX2-MSUB)-1                                                      
      GO TO 3001                                                                          
 3015 NDEL=NCLN(IX1-MSUB)+NCL(IX2)-1                                                      
      GO TO 3001                                                                          
 3017 NDEL=NCLN(IX1-MSUB)+NCLN(IX2-MSUB)-1                                                
      GO TO 3001                                                                          
 ...
 2136 FORMAT(1H ,2(I3,2X),2(A6,1X),2A6,2(A6,1X),2A6,46X,F20.8)                            
   58 CONTINUE                                                            140168          
      CALL REMARK(58H   BACK INVERSION COMPLETED - STARTING RESIDUALS,AN                  
     1OVA,ETC)                                                                            
C     ----------------------------------------------------                140169          
