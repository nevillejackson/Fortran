...
C     ----------------------------------------------------                070009          
     ...
     1L,L7                                                                070028          
      ...
      CALL REMARK(26H   READING PARAMETER CARDS)                                          
C     --------------------------------------------------                                  
...
C     ----------------------------------------------------                070092          
  ...
  203 DO 204 I=1,NED                                                                      
      READ(5,1100) IED(I),(IC(J),J=1,7)                                                   
 1100 FORMAT(I14,6A10,A6)                                                                 
  204 WRITE(6,1101) I,IED(I),(IC(J),J=1,7)                                                
 1101 FORMAT(1H0,8HFOR I = ,I2,9H   IED(I)/1H ,I15,5X,6A10,A6)                            
...
C     ----------------------------------------------------                070554          
 ...
 1022 FORMAT (1H0,73HCODES FOR EFFECTS NOT CONSECUTIVE---CHECK PARAMETER  070566          
     1 CARDS FOR PROBLEM NO.,I3)                                          070567          
      MULL=1                                                              070568          
   75 CONTINUE                                                            070569          
      IF(IM(K8).NE.NLHM) 76,947                                                           
  947 WRITE(6,1024) IJOB,NLHM,(IM(I),I=1,K8)                                              
 1024 FORMAT(31H0NLHM INCORRECT FOR PROBLEM NO.,I3/                                       
     1 8H NLHM = ,I4/20H CUMULATIVE DF"S ARE,(/1H ,20I5))                                 
      MULL=1                                                                              
   76 NS=K8-1                                                                             
      RETURN                                                              070571          
      END                                                                 070572          
